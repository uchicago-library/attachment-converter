...
module type Parser = sig
  ...
  val fold : ('a -> (string, string) result -> 'a) -> 'a -> in_channel -> 'a
...
module MBoxParser : Parser = struct
  ...
  (* TODO: check in here to see whether something could be causing the
     parse errors *)
  let fold fn acc chan =
  ...
  (* TODO: also check in here to see whether something could be
     causing the parse errors *)
