Testing docx to pdfa conversion
  $ ../../conversion-scripts/soffice-wrapper.sh -i docx -o pdf < test-docx.docx > converted-docx-to-pdfa.pdf



Output:
  $ file --mime-type converted-docx-to-pdfa.pdf
  converted-docx-to-pdfa.pdf: application/pdf
  $ pdftotext -eol unix converted-docx-to-pdfa.pdf
  $ cat converted-docx-to-pdfa.txt
  Lorem ipsum
  ...
  imperdiet. Morbi velit neque, semper quis lorem quis, efficitur dignissim ipsum. Ut ac
  lorem sed turpis imperdiet eleifend sit amet id sapien.
