Testing doc to text conversion:
  $ ../../conversion-scripts/soffice-wrapper.sh -i doc -o txt < test-doc.doc > converted-doc-to-text.txt



Output:
  $ file --mime-type converted-doc-to-text.txt
  converted-doc-to-text.txt: text/plain
  $ cat converted-doc-to-text.txt
  ﻿Lorem ipsum 
