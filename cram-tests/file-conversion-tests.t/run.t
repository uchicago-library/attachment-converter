...
Testing docx to pdfa conversion
  $ ../../conversion-scripts/soffice-wrapper.sh -i docx -o pdf < test-docx.docx > converted-test-docx-to-pdfa.pdf
  ...
  $ pdftotext expected-converted-test-docx-to-pdfa.pdf
  $ pdftotext converted-test-docx-to-pdfa.pdf
  $ diff expected-converted-test-docx-to-pdfa.txt converted-test-docx-to-pdfa.txt
  $ fileType=$(file --mime-type converted-test-docx-to-pdfa.pdf | sed -E 's/(.*)(: )(.*)/\3/') 
